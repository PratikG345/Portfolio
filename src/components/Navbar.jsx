  ...
  return (
    <div className="z-[1000] isolate h-[80px] px-5 py-6 fixed bg-transparent w-full flex justify-between items-center mix-blend-hard-light">
      <button onClick={handleLandingScroll}>
        <Heading2 className="text-[#FFFFF0] ">{"Pratik"}</Heading2>
      </button>
      <div className="relative">
        <div
          ref={circleRef}
          className="circle bg-[#FFFFF0] h-8 w-8 rounded-full mr-5 overflow-hidden absolute top-1/2 right-1/2 transform translate-x-1/2 -translate-y-1/2 cursor-pointer"
